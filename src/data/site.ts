...
export const videoItems: VideoItem[] = [
  {
    ...
    hevcSrc: "/videos/showcase-5-hevc.mp4",
    webmSrc: "/videos/showcase-5.webm",
    mobileSrc: "/videos/showcase-5-mobile.mp4",
    mobileHevcSrc: "/videos/showcase-5-mobile-hevc.mp4",
    mobileWebmSrc: "/videos/showcase-5-mobile.webm",
    aspect: "landscape",
    featured: true,
  },
  {
    ...
    hevcSrc: "/videos/showcase-6-hevc.mp4",
    webmSrc: "/videos/showcase-6.webm",
    mobileSrc: "/videos/showcase-6-mobile.mp4",
    mobileHevcSrc: "/videos/showcase-6-mobile-hevc.mp4",
    mobileWebmSrc: "/videos/showcase-6-mobile.webm",
    aspect: "portrait",
  },
  {
    id: "video-featured",
    ...
    duration: "00:34",
    poster: "/images/videos/showcase-1-poster.webp?v=2",
    src: "/videos/showcase-1.mp4?v=2",
    hevcSrc: "/videos/showcase-1-hevc.mp4?v=2",
    webmSrc: "/videos/showcase-1.webm?v=2",
    mobileSrc: "/videos/showcase-1-mobile.mp4?v=2",
    mobileHevcSrc: "/videos/showcase-1-mobile-hevc.mp4?v=2",
    mobileWebmSrc: "/videos/showcase-1-mobile.webm?v=2",
    aspect: "landscape",
  },
  {
  ...
  },
  {
    ...
    duration: "00:37",
    poster: "/images/videos/showcase-2-poster.webp?v=2",
    src: "/videos/showcase-2.mp4?v=2",
    hevcSrc: "/videos/showcase-2-hevc.mp4?v=2",
    webmSrc: "/videos/showcase-2.webm?v=2",
    mobileSrc: "/videos/showcase-2-mobile.mp4?v=2",
    mobileHevcSrc: "/videos/showcase-2-mobile-hevc.mp4?v=2",
    mobileWebmSrc: "/videos/showcase-2-mobile.webm?v=2",
    aspect: "landscape",
  },
];
